...
def betweeness_approximate(G, num_samples=5000, quiet=False, source_nodes_list=None, target_nodes_list=None, seed=0):
    '''
    ...
    -------
        ...
        source_nodes_list (list of int): a list of node IDs to be used as source nodes for the approximate BC computation.
        If the list set to None then all nodes in the graph are used as source nodes

        target_nodes_list (list of int): a list of node IDs to be used as target nodes for the approximate BC computation.
        If the list set to None then all nodes in the graph are used as target nodes
    ...
    '''
    start = timer()
    betweeness = nk.centrality.EstimateBetweenness(G, nSamples = num_samples, parallel=True, normalized=True, sources=source_nodes_list, targets=target_nodes_list, seed=seed).run()
